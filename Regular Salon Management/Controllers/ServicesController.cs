...
namespace Regular_Salon_Management.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ServiceName,ServiceCost")] Services services)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ServiceName,ServiceCost")] Services services)
        {
            if (ModelState.IsValid)
            {
