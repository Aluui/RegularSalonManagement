...
namespace Regular_Salon_Management.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ProductName,ProductCost")] Products products)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ProductName,ProductCost")] Products products)
        {
            if (ModelState.IsValid)
            {
