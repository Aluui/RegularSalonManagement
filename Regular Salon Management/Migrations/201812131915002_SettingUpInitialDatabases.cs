namespace Regular_Salon_Management.Migrations
{
    ...
    public partial class SettingUpInitialDatabases : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ClientAppointment = c.DateTime(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Clients", "ProductId", "dbo.Products");
            ...
            DropIndex("dbo.Clients", new[] { "ProductId" });
